<div class="toolkit">
    ...
    <script>$("title").text("Мой профиль"); </script>
    <?php
    ...
    <div class="profile-page col-lg-9" style="margin: auto">
        ...
        <form class="form-data-profile">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="box-searchCity">
                        <input type="text" class="form-control" autocomplete="off" name="login" value="<?php echo $profile['login']; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="box-searchCity">
                        <input type="text" class="form-control" autocomplete="off" name="name" value="<?php echo $profile['name']; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="box-searchCity">
                        <input type="text" class="form-control" autocomplete="off" name="surname" value="<?php echo $profile['surname']; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="box-searchCity">
                        <input type="text" class="form-control" autocomplete="off" name="email" value="<?php echo $profile['email']; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="box-searchCity">
                        <input type="text" class="form-control" autocomplete="off" name="phone" value="<?php echo $profile['phone']; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="dropdown bootstrap-select change-filter-item"><select name="type_person"
                            ...
                            <?php echo $CategoryAll->outNameTypePerson($profile['type_person']); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-xl-6">
                    <div class="box-searchCity">
                        <label class="col-lg-4 col-form-label" style="font-weight: 600;"><?php if($profile['status']){echo "Активен";}else{echo "Заблокирован";}?></label>
                    </div>
                </div>
            </div>
            <div class="row">
